							...
							<div className="card-bottom">
								<div className="card-body text-center card-hair">
									...
									<p className="card-text">
										The experts stylists at Sparkle Salon
										will shape your look, from classic to
										modern, with a variety of luxurious hair
						...
						<div className="card">
							...
							<div className="card-bottom">
								<div className="card-body text-center card-nails">
									...
									<p className="card-text">
										Spoil yourself with our treatment which
										includes soak, cuticles care, hand
										massage, nail restyle, buff and polish
									</p>
									<Link
										to="/nails"
										className="btn btn-warning">
